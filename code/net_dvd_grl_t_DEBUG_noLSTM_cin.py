...
# C:flops: 279456.26 M, params: 21.99 M
# F:flops: 34054.16 M, params: 1.46 M
...
if __name__ == '__main__':
    ...
    summary(net,(3,5,240,320),batch_size=1,device="cuda")
    # CUDA_VISIBLE_DEVICES=2 python net_dvd_grl_t_DEBUG_noLSTM_cin.py 2>&1 | tee rvd_c_framework.log
