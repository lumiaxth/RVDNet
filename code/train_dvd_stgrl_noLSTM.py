...
def validate(args, net_C, net_F):
    ...
    for batch_idx, sample in enumerate(test_loader):
        ...
        with torch.no_grad():
            ...
            model_out_F, _ = net_F(model_out_C)  # (b, c, 1, h, w)
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for batch_idx, (sample, domain_sample) in enumerate(zip(train_loader,domain_loader)):
            ...
            if args.freeze_net_F:
                ...
                model_out_F, source_domain_feature_F = net_F(model_out_C.detach())
                _, target_domain_feature_F = net_F(target_out_C.detach())
