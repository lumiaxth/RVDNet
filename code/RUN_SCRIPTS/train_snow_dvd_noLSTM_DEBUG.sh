...
python train_dvd_stgrl_noLSTM_cin.py --epochs 120 \
               ...
               --train_file /home/xth/RVDNet/data/Dataset_Training_Synthetic_empty.json \
               --eval_file /home/xth/RVDNet/data/Dataset_Testing_Synthetic_C.json \
               --checkpoint_dir_best /home/xth/RVDNet/code/checkpoint/best/t8 \
               --batch_size 8 \
               --input_residue \
	           --F_dvd \
	           --val_mode all \
               --backbone resnet18 \
               --refinenet R_CLSTM_5 \
               --checkpoint_dir_C ./checkpoint/C/noLSTM/trial8 \
               --checkpoint_dir_F ./checkpoint/F/noLSTM/trial8 \
               --logdir ./log/ \
               --eval_interval 2 \
               --use_bilstm \
               --use_grl \
