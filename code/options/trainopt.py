...
def _get_train_opt():
    ...
    parser.add_argument('--F_dvd', action='store_true', default=True, help='if True, fine net turns to use fastdvdnet')
    parser.add_argument('--torch_home', type=str, default=None)

    # GRL
    parser.add_argument('--use_grl', action='store_true', default=False, help='use GRL or not.')
    parser.add_argument('--alpha', type=float, default=0.01, help='weight of s-grl')
    parser.add_argument('--beta', type=float, default=0.05, help='weight of t-grl')
    # optimization
    ...
    parser.add_argument('--train_file', type=str, required=True, help='the path of indexfile',
                        default='/home/xth/RVDNet/data/Dataset_Training_Synthetic_F.json')
    parser.add_argument('--eval_file', type=str, required=True, help='the path of indexfile',
                        default='/home/xth/RVDNet/data/Dataset_Testing_Synthetic_C.json')
    ...
    parser.add_argument('--data_root', type=str, required=True, help="the root path of image data.",
                        default='/home/xth/dataset/SnowScape')
    parser.add_argument('--domain_target_file', default='/home/xth/RVDNet/data/Real.json')
    parser.add_argument('--checkpoint_dir_best',default='/home/xth/RVDNet/code/best_checkpoints')
